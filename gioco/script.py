...
class Personaggio:
    def __init__(self, screen, pos, size ) -> None:
        ...
        self.image = pygame.image.load('drago-removebg-preview - Copia.png')
    ...
    def muovi(self):
        ...
        if self.moving_right:   
            self.image = pygame.image.load('drago-removebg-preview - Copia inv.png')
...
class bush:
    def __init__(self, screen, pos, size) -> None:
        self.screen = screen
        self.rect = pygame.Rect(pos[0], pos[1], size[0], size[1])
        self.image = pygame.image.load('bush-removebg-preview.png')
        self.image = pygame.transform.scale(self.image, size)
    def draw(self):
        self.screen.blit(self.image, self.rect)
